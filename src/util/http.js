export async function fetchProjects() {
  ...
  const response = await fetch(
    "http://localhost:5001/ExternalApis/GetAllProperties?pageIndex=1&pageSize=10",
    requestOptions
  );
...
export async function fetchProjectsByName(projectName) {
  ...
  const response = await fetch(
    "http://localhost:5001/ExternalApis/GetAllProperties?pageIndex=1&pageSize=1",
    requestOptions
  );
...
export async function fetchProjectsByCountry(projectId) {
  ...
  const response = await fetch(
    "http://localhost:5001/ExternalApis/GetLookupItems?lookupParentId="+projectId,
    requestOptions
  );
