...
const ContactForm = (props) => {
  ...
  return (
    <form onSubmit={submitHandler} className={props.formMainCSS}>
      {(postId == 'Success') ? <div className="block  p-3 mb-5 rounded bg-green-500">Success</div> : ''}
      {(postId == 'Error') ? <div className="block  p-3 mb-5 rounded bg-red-500">Error</div> : ''}

      <div className="border-gray-900/10 pb-12 ">
        <h2 className="text-base font-semibold leading-7  text-xl">
          {props.formMainTitle}
        </h2>
